...
int main(int argc, char **argv) {
  ...
  while (1) {
    ...
    case RelOp:
       ...
       */
      if (verbose) { 
		printf("Op de comparaison:\t%s ", yytext);
		switch(yylval.C) {
			case EQ: printf("egalite\n"); break;
			case NE: printf("non egalite\n"); break;
			case GT: printf("plus grand que\n"); break;
			case GE: printf("plus grand ou egual\n"); break;
			case LT: printf("plus petit que\n"); break;
			case LE: printf("plus petit ou egal\n"); break;
